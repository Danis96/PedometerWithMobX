...
class ForgotSetPasswordPage extends StatelessWidget {
  const ForgotSetPasswordPage(this.authStore, {Key? key}) : super(key: key);
  ...
  Widget _buildHeadline(BuildContext context) {
    return Padding(
      ...
      child: ListView(
        ...
        children: <Widget>[
          Image.asset('assets/ic_reg_pass_headline.png', height: MediaQuery.of(context).size.height / 2.3),
  ...
  Widget _buildPasswordField(BuildContext context) {
    return FOSTextFormField(
      ...
      controller: authStore.passwordFPController,
  ...
  Widget _buildConfirmPasswordField(BuildContext context) {
    return FOSTextFormField(
      ...
      controller: authStore.confirmPasswordFPController,
      onChange: (String? value) {},
    );
  }
        ...
        onPressed: () {
          ...
          if (passCharLengthValidation != null) {
            ...
            if (arePasswordsSame != null) {
              ...
              authStore.resetPassword().then((String? error) {
                Navigator.of(context).pop();
                ModalHelper()
                    .returnErrorModalOrFn(context, error, function: () => Navigator.of(context).pushNamed(loginScreen, arguments: authStore));
              });
            }
          }
        },
