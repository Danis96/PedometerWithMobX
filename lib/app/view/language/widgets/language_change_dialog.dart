...
class LanguageChangeDialog extends StatelessWidget {
  ...
  const LanguageChangeDialog({Key? key, required this.languageName, required this.onChange}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Platform.isAndroid
        ? AlertDialog(
            ...
            actions: [
              TextButton(onPressed: onChange, child: Text('common.yes'.tr())),
              TextButton(onPressed: () => Navigator.of(context).pop(), child: Text('common.no'.tr()))
            ],
          )
